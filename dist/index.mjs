...
function AspectRatio({ ...props }) {
  return /* @__PURE__ */ React.createElement(AspectRatio$1.Root, { "data-slot": "aspect-ratio", ...props });
}
function Avatar({
  className,
  size = "default",
